...
const Feedback = () => {
  ...
  if (success) {
    return (
      <div className="relative min-h-screen bg-white flex flex-col">
        <Navbar />
        <main className="flex-grow bg-brand-light flex items-center justify-center px-4 py-20 pt-56 md:pt-64">
  ...
  return (
    <div className="relative min-h-screen bg-white flex flex-col">
      <Navbar />
      <main className="flex-grow bg-brand-light flex flex-col items-center justify-center py-20 pt-56 md:pt-64 px-4">
