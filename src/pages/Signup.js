    ...
    <div className="min-h-screen bg-brand-light flex items-center justify-center px-4">
      <div className="max-w-md w-full bg-white rounded-[2.5rem] shadow-2xl shadow-brand/10 p-10 md:p-12 border border-dark/5">
        ...
        <button
          ...
          className="w-full mb-6 bg-white border border-dark/5 py-4 rounded-2xl font-bold text-xs uppercase tracking-widest text-dark flex items-center justify-center gap-3 hover:bg-gray-50 transition-all active:scale-95 shadow-sm"
        >
